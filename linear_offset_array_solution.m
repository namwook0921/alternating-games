...
for i = T: -1: 2
   ...
   Q2_array_cumulative(:, :, i - 1) = Q2_array(:, :, i - 1) + V2_array(:, :, i)' * Q2_array_cumulative(:, :, i) * V2_array(:, :, i) ...
       + Y2_array(:, :, i)' * R2_array_cumulative(:, :, i) * Y2_array(:, :, i) + 2 * V2_array(:, :, i)' * P2_array_cumulative(:, :, i) * Y2_array(:, :, i);
   R2_array_cumulative(:, :, i - 1) = R2_array(:, :, i - 1) + W2_array(:, :, i)' * Q2_array_cumulative(:, :, i) * W2_array(:, :, i) ...
       + Z2_array(:, :, i)' * R2_array_cumulative(:, :, i) * Z2_array(:, :, i) + 2 * W2_array(:, :, i)' * P2_array_cumulative(:, :, i) * Z2_array(:, :, i);
   ...
   Q1_array_cumulative(:, :, i - 1) = Q1_array(:, :, i - 1) + V1_array(:, :, i)' * Q1_array_cumulative(:, :, i) * V1_array(:, :, i) ...
       + Y1_array(:, :, i)' * R1_array_cumulative(:, :, i) * Y1_array(:, :, i) + 2 * V1_array(:, :, i)' * P1_array_cumulative(:, :, i) * Y1_array(:, :, i);
   R1_array_cumulative(:, :, i - 1) = R1_array(:, :, i - 1) + W1_array(:, :, i)' * Q1_array_cumulative(:, :, i) * W1_array(:, :, i) ...
       + Z1_array(:, :, i)' * R1_array_cumulative(:, :, i) * Z1_array(:, :, i) + 2 * W1_array(:, :, i)' * P1_array_cumulative(:, :, i) * Z1_array(:, :, i);
