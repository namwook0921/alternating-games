...
P1_array_cumulative = zeros(P_size(1), P_size(2), T);
P2_array_cumulative = zeros(P_size(1), P_size(2), T);
...
P1_array_cumulative(:, :, end) = P1_array(:, :, end);
P2_array_cumulative(:, :, end) = P2_array(:, :, end);
...
T1_array(:, :, T) = (R1_array_cumulative(:, :,T) + B1_array(:, :, T)' * Q1_array_cumulative(:, :,T) * B1_array(:, :, T) + B1_array(:, :, T)' * P1_array_cumulative(:, :,T) ...
    + P1_array_cumulative(:, :,T)' * B1_array(:, :, T)) \ (B1_array(:, :, T)' * Q1_array_cumulative(:, :,T) + P1_array_cumulative(:, :,T)') * B2_array(:, :, T - 1);
...
for i = T: -1: 2
   ...
   Q2_array_cumulative(:, :, i - 1) = Q2_array(:, :, i - 1) + V2_array(:, :, i)' * Q2_array_cumulative(:, :, i) * V2_array(:, :, i) ...
       + Y2_array(:, :, i)' * R2_array_cumulative(:, :, i) * Y2_array(:, :, i) ...
       + V2_array(:, :, i)' * P2_array_cumulative(:, :, i) * Y2_array(:, :, i) ...
       + Y2_array(:, :, i)' * P2_array_cumulative(:, :, i)' * V2_array(:, :, i);
   R2_array_cumulative(:, :, i - 1) = R2_array(:, :, i - 1) + W2_array(:, :, i)' * Q2_array_cumulative(:, :, i) * W2_array(:, :, i) ...
       + Z2_array(:, :, i)' * R2_array_cumulative(:, :, i) * Z2_array(:, :, i) ...
       + W2_array(:, :, i)' * P2_array_cumulative(:, :, i) * Z2_array(:, :, i)...
       + Z2_array(:, :, i)' * P2_array_cumulative(:, :, i)' * W2_array(:, :, i);
   P2_array_cumulative(:, :, i - 1) = P2_array(:, :, i - 1) + V2_array(:, :, i)' * Q2_array_cumulative(:, :, i) * W2_array(:, :, i) ...
       ...
       + Y2_array(:, :, i)' * P2_array_cumulative(:, :, i)' * W2_array(:, :, i);

   % Compute S2, T2
   S2_array(:, :, i - 1) = (R2_array_cumulative(:, :, i - 1) + B2_array(:, :, i - 1)' * Q2_array_cumulative(:, :, i - 1) * B2_array(:, :, i - 1) + B2_array(:, :, i - 1)' * P2_array_cumulative(:, :, i - 1) ...
        + P2_array_cumulative(:, :, i - 1)' * B2_array(:, :, i - 1)) \ (B2_array(:, :, i - 1)' * Q2_array_cumulative(:, :, i - 1) + P2_array_cumulative(:, :, i - 1)') * A_prime_array(:, :, i - 1);
   T2_array(:, :, i - 1) = (R2_array_cumulative(:, :, i - 1) + B2_array(:, :, i - 1)' * Q2_array_cumulative(:, :, i - 1) * B2_array(:, :, i - 1) + B2_array(:, :, i - 1)' * P2_array_cumulative(:, :, i - 1) ...
        + P2_array_cumulative(:, :, i - 1)' * B2_array(:, :, i - 1)) \ (B2_array(:, :, i - 1)' * Q2_array_cumulative(:, :, i - 1) + P2_array_cumulative(:, :, i - 1)') * B1_array(:, :, i - 1);
   ...
   Q1_array_cumulative(:, :, i - 1) = Q1_array(:, :, i - 1) + V1_array(:, :, i)' * Q1_array_cumulative(:, :, i) * V1_array(:, :, i) ...
       ...
       + Y1_array(:, :, i)' * P1_array_cumulative(:, :, i)' * V1_array(:, :, i);
   R1_array_cumulative(:, :, i - 1) = R1_array(:, :, i - 1) + W1_array(:, :, i)' * Q1_array_cumulative(:, :, i) * W1_array(:, :, i) ...
       ...
       + Z1_array(:, :, i)' * P1_array_cumulative(:, :, i)' * W1_array(:, :, i);
   ...
   % Compute S1, T1
   S1_array(:, :, i - 1) = (R1_array_cumulative(:, :, i - 1) + B1_array(:, :, i - 1)' * Q1_array_cumulative(:, :, i - 1) * B1_array(:, :, i - 1) + B1_array(:, :, i - 1)' * P1_array_cumulative(:, :, i - 1) + ...
   P1_array_cumulative(:, :, i - 1)' * B1_array(:, :, i - 1)) \ (B1_array(:, :, i - 1)' * Q1_array_cumulative(:, :, i - 1) + P1_array_cumulative(:, :, i - 1)') * A_array(:, :, i);
   if i > 2
       T1_array(:, :, i - 1) = (R1_array_cumulative(:, :, i - 1) + B1_array(:, :, i - 1)' * Q1_array_cumulative(:, :, i - 1) * B1_array(:, :, i - 1) + B1_array(:, :, i - 1)' * P1_array_cumulative(:, :, i - 1) + ...
           P1_array_cumulative(:, :, i - 1)' * B1_array(:, :, i - 1)) \ (B1_array(:, :, i - 1)' * Q1_array_cumulative(:, :, i - 1) + P1_array_cumulative(:, :, i - 1)') * B2_array(:, :, i - 2);
   else 
       T1_array(:, :, i - 1) = (R1_array_cumulative(:, :, i - 1) + B1_array(:, :, i - 1)' * Q1_array_cumulative(:, :, i - 1) * B1_array(:, :, i - 1) + B1_array(:, :, i - 1)' * P1_array_cumulative(:, :, i - 1) + ...
...
L1 = 1/2 * X_prime_array(:, :, 1)' * Q1_array_cumulative(:, :, 1) * X_prime_array(:, :, 1) ...
    + 1/2 * U1_array(:, :, 1)' * R1_array_cumulative(:, :, 1) * U1_array(:, :, 1) ...
    + X_prime_array(:, :, 1)' * P1_array_cumulative(:, :, 1) * U1_array(:, :, 1);

L2 = 1/2 * X_array(:, :, 2)' * Q2_array_cumulative(:, :, 1) * X_array(:, :, 2) ...
    + 1/2 * U2_array(:, :, 1)' * R2_array_cumulative(:, :, 1) * U2_array(:, :, 1) ...
